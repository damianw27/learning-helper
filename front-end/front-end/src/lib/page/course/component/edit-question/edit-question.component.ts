...
export class EditQuestionComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder, private httpClient: HttpClient, private changeDetectorRef: ChangeDetectorRef) {}
  ...
  ngOnInit(): void {
    ...
    this.question.answers.map(answer => this.answerToFormGroup(answer)).forEach(answerGroup => this.answersArray.push(answerGroup));
  ...
  onSubmit(event: SubmitEvent): void {
    ...
    const request$ = this.httpClient.post<Question>(`/api/question/update`, this.questionForm.value);
