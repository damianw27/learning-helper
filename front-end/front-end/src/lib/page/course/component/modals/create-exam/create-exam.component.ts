...
export class CreateExamComponent implements OnChanges, OnInit {
  ...
  constructor(public activeModal: NgbActiveModal, private formBuilder: FormBuilder, private httpClient: HttpClient) {}
  ...
  public ngOnChanges(changes: SimpleChanges): void {
    ...
    console.log(this.examDefinitionForm.value, this.courseId);
  ...
  public onSubmit(event: SubmitEvent): void {
    ...
    const request$ = this.httpClient.post(`/api/exam-definition/create`, this.examDefinitionForm.value);
